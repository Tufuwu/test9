    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_ptr', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='a4_candy_mapideas_mapidea', serialize=False, to='a4modules.Item')),
                ...
                ('labels', models.ManyToManyField(related_name='a4_candy_mapideas_mapidea_label', to='a4labels.Label', verbose_name='Labels')),
